...
<body>
    ...
    <div class="album-header">
        <h2 class="add-album-title">我的相簿 📂 <button class="album-add-btn" id="addAlbumBtn">＋</button></h2>
    </div>
    ...
    <div class="album-header">
        <h2 class="category-title">依時間分類 🕰️</h2>
    </div>
    <div class="album-section">
    ...
    <div class="album-header">
        <h2 class="category-title">依地點分類 🗺️</h2>
    </div>
    <div class="album-section">
            ...
            if (data.status === 'success' && data.photos_by_location) {
                ...
                Object.keys(data.photos_by_location).forEach(location => {
                    ...
                    card.innerHTML = `
                        ...
                        <div class="album-card-title">${location} (${photos.length})</div>
                    `;
