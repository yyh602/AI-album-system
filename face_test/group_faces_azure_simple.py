...
# -*- coding: utf-8 -*-
"""
使用 insightface 的人臉分群腳本 - 簡化修正版
使用更直接的方法修正 onnxruntime providers 問題
"""
...
try:
    ...
    # 直接修改 onnxruntime 的 InferenceSession
    ...
    # 替換全域的 InferenceSession
    ort.InferenceSession = fixed_inference_session
            ...
            try:
                ...
                for model_path in model_paths:
                    if os.path.exists(model_path):
                        ...
                        # 簡化修正版：使用全域替換的 InferenceSession
