...
# -*- coding: utf-8 -*-
"""
使用 insightface 的人臉分群腳本 - Azure 兼容版本
保持與原本 group_faces.py 完全相同的邏輯
"""
...
try:
    ...
    print("⚠️ insightface 無法載入，將使用備用方案")
    USE_INSIGHTFACE = False

def extract_features_with_insightface(img_path):
    """使用 insightface 提取特徵（與原本 group_faces.py 相同）"""
    try:
...
def group_faces():
    """主要的人臉分群函數（與原本 group_faces.py 邏輯完全相同）"""
